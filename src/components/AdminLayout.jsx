...
import {
  ...
  Book, Award, File, UserCog, ExternalLink, UserCheck, Presentation, Languages, Upload, FlaskConical, Replace
} from 'lucide-react';
...
const ADMINISTRACAO = [
  ...
  { to: '/admin/taxonomia-refs', label: 'Refs. de Importação', icon: Replace },
